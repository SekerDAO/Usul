...
abstract contract BaseQuorumFixed is OwnableUpgradeable {
    ...
    event QuorumThresholdUpdated(uint256 oldQuorumThreshold, uint256 newQuorumThreshold);
    ...
    function updateQuorumThreshold(uint256 newQuorumThreshold) public onlyOwner {
